...
void TrendlineEstimator::UpdateTrendline(double recv_delta_ms,
  ...
  //Yuhao added
  //RTC_LOG(LS_INFO) << "Delay Gradient: " << delta_ms;
  const int64_t one_way_delay = arrival_time_ms - send_time_ms;
  RTC_LOG(LS_INFO) << "One way delay: " << one_way_delay << "  time: " << arrival_time_ms;
  ++num_of_deltas_;
  ...
  //Yuhao added
  //RTC_LOG(LS_INFO) << "trendline_slope: " << trend << "arrival time: " << arrival_time_ms;
...
void TrendlineEstimator::Detect(double trend, double ts_delta, int64_t now_ms) {
  ...
  //Yuhao added
  //RTC_LOG(LS_INFO) << "estimated delay gradient: " << modified_trend << "  threshold: " << threshold_ << "  time: " << now_ms;
  if (modified_trend > threshold_) {
	...
	//Yuhao added
	RTC_LOG(LS_INFO) << "estimated delay gradient: " << modified_trend << "\tthreshold: " << threshold_ << "\tOverusing" << "\ttime: " << now_ms;
      }
    }
    ...
    //Yuhao added
    RTC_LOG(LS_INFO) << "estimated delay gradient:  " << modified_trend << "\tthreshold:  " << threshold_ << "\tUnderusing\t" << "time:  " << now_ms;
  } else {
    time_over_using_ = -1;
    overuse_counter_ = 0;
    hypothesis_ = BandwidthUsage::kBwNormal;
    //Yuhao added
    RTC_LOG(LS_INFO) << "estimated delay gradient: " << modified_trend << "\tthreshold: " << threshold_ << "\tNormal" << "\ttime: " << now_ms;
  }
  prev_trend_ = trend;
  UpdateThreshold(modified_trend, now_ms);
  //Yuhao added
  RTC_LOG(LS_INFO) << "update threshold to: " << threshold_ << "\ttime:  " << now_ms;
}
